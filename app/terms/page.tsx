...
export const metadata: Metadata = {
  title: "Terms of Service — Med-Gen Insurance Agency",
  description:
    "Terms of Service for Med-Gen Insurance Agency. Please read these terms carefully before using our platform.",
  keywords: [
    "terms of service",
    "terms and conditions",
    "Med-Gen Insurance",
    "insurance terms Kenya",
  ],
  openGraph: {
    title: "Terms of Service — Med-Gen Insurance Agency",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Terms of Service — Med-Gen Insurance Agency",
      },
    ],
  },
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-16">
          <div className="prose prose-lg max-w-none text-muted-foreground">
            <p className="lead text-xl mb-8">
              Welcome to Med-Gen Insurance Agency. By accessing or using our
              platform, you agree to be bound by these Terms of Service and all
